...
<table style="margin-left: auto; margin-right: auto;">
	...
	<tr>
		...
		<td>${dto.num}</td>
		<td><a href="detailpage.cu?pageNum=${pageNum}&num=${dto.num}"><img src="${images}top/${dto.c_img}"></a></td>
		<td>${dto.c_subject}</td>
		<td>${dto.c_age}</td>
		<td>${dto.c_color}</td>
		<td>${dto.c_price}</td>
		...
		onclick="window.location='order.cu?pageNum=${pageNum}&img=${dto.c_img }&num=${dto.num}&age=${dto.c_age}&color=${dto.c_color}&price=${dto.c_price}&subject=${dto.c_subject}'">
		<input class="button" type="submit" value="개별 삭제">
		</td>
	</tr>
	</c:forEach>
</table>
